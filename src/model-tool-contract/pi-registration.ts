...
import { createPiTeamsResultRenderer } from "../utils/tool-result-renderer";
...
export function registerModelToolJourney(
  ...
  > = {
    ...
    renderResult: createPiTeamsResultRenderer("team_create"),
  ...
  > = {
    ...
    renderResult: createPiTeamsResultRenderer("team_sync"),
  ...
  > = {
    ...
    renderResult: createPiTeamsResultRenderer("ensure_worker"),
  ...
  > = {
    ...
    renderResult: createPiTeamsResultRenderer("task_create"),
  ...
  > = {
    ...
    renderResult: createPiTeamsResultRenderer("task_read"),
  ...
  > = {
    ...
    renderResult: createPiTeamsResultRenderer("task_update"),
  ...
  const workerStopTool: ToolDefinition<typeof CandidateWorkerStopParametersSchema, CandidateWorkerStopResult> = {
    ...
    renderResult: createPiTeamsResultRenderer("worker_stop"),
  ...
  const teamShutdownTool: ToolDefinition<typeof CandidateTeamShutdownParametersSchema, CandidateTeamShutdownResult> = {
    ...
    renderResult: createPiTeamsResultRenderer("team_shutdown"),
  ...
  const taskLinkTool: ToolDefinition<typeof CandidateTaskLinkParametersSchema, CandidateTaskLinkResult> = {
    ...
    renderResult: createPiTeamsResultRenderer("task_link"),
  ...
  const alertSendTool: ToolDefinition<typeof CandidateAlertSendParametersSchema, CandidateAlertSendResult> = {
    ...
    renderResult: createPiTeamsResultRenderer("alert_send"),
